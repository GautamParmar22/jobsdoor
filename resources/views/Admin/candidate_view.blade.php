...
<div class="app-wrapper">
	<?php //echo "<pre>"; print_r($getPersonalDetails);"</pre>"; 
	/*echo "<pre>"; print_r($candiadte_view);"</pre>";
	      
	      echo "<pre>"; print_r($emp_history);"</pre>";
	      echo "<pre>"; print_r($education_details);"</pre>";
	      echo "<pre>"; print_r($job_preference);"</pre>";*/ ?>
	<div class="app-content pt-3 p-md-3 p-lg-4">
		<div class="container-xl">	
	            		...
	            		<div class="app-card app-card-settings shadow-sm p-4">
				    		<div class="app-card-body">
				                ...
				                <div class="mb-2"><strong>Resume:  </strong>
				                	<a href="{{env('APP_URL')}}resume/{{$getPersonalDetails->resume}}" download="{{$getPersonalDetails->resume}}" target="_blank" class="btn btn-info btn-sm" >View resume</a>
				                </div>                                               
				    		</div><!--//app-card-body-->
						</div><!--//app-card-->
	        		</div>
	    		...
	    		<div class="row g-4 settings-section">
	        		...
	        		<div class="col-12 col-md-8">
	            		<div class="app-card-body">
				    		<?php if($getPersonalDetails->is_first_job==0) { ?>
	        		...
	        		<div class="col-12 col-md-8">
	            		<div class="app-card app-card-settings shadow-sm p-4">
				    		<div class="app-card-body">
				    			<div class="mb-2"><strong>School name:  </strong>{{$education_details->school_name}}</div>
				    	        <div class="mb-2"><strong>Degree:  </strong>{{$education_details->degree}}</div>
				    	        <div class="mb-2"><strong>Education start year:  </strong>{{$education_details->edu_start_year}}</div>
				    	        <div class="mb-2"><strong>Education start month:  </strong>{{$education_details->edu_start_month}}</div>
				    	        <div class="mb-2"><strong>Education end year:  </strong>{{$education_details->edu_end_year}}</div>
				    	        <div class="mb-2"><strong>Education end month:  </strong>{{$education_details->edu_end_month}}</div>
				    	    </div><!--//app-card-body-->
						</div><!--//app-card-->
	        		</div>
	    		</div><!--//row-->
	        		...
	        		<div class="col-12 col-md-8">
	            		<div class="app-card app-card-settings shadow-sm p-4">
				    		<div class="app-card-body">
				    	        ...
				    	        <div class="mb-2"><strong>Important skill:  </strong>{{$job_preference->important_roll}}</div>
				    	        <div class="mb-2"><strong>Tell your self:  </strong>{{$job_preference->tell_yourself}}</div>
				    		</div><!--//app-card-body-->
						</div><!--//app-card-->
	        		</div>
	    		</div><!--//row-->	
