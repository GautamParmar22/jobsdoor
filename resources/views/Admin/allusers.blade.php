												...
												echo "Candidate";
																					...
																					<td class="cell">
																						<span>
																							<?php
											if (@$alldata->role_type == 2) {
												echo @$alldata->emp_mobile;
											} else {
												echo @$alldata->cnd_mobile;
											}
																									?>
																						</span>
																					</td>
																					<td class="cell">
																						<span>
																							<?php 
																										if (empty(@$alldata->official_title)) {
												echo "--";
											} else {
												echo @$alldata->official_title;
											}
																									?>
																						</span>
																					</td>
											...
											if (@$alldata->status) {
												...
												echo '<span class="badge bg-danger">Inactive</span>';
																					...
																					<td class="cell">
																						...
																						<a href="{{url('view-employers/' . base64_encode(@$alldata->id))}}"><i
																								class="fa fa-eye" aria-hidden="true"
																								style="color:gray; display: inline-block; margin: 0 10px 0 0; font-size: 1.2em;"></i></a>
																						<?php } else { ?>
																						<a href="{{url('view-candidate/' . base64_encode(@$alldata->id))}}"><i
																								class="fa fa-eye" aria-hidden="true"
																								style="color:gray; display: inline-block; margin: 0 10px 0 0; font-size: 1.2em;"></i></a>
																						<?php } ?>

																						<?php if (@$alldata->role_type == 2) { ?>
																						<a href="{{url('edit-employer/' . @$alldata->id)}}"><i class="fa fa-edit"
																								aria-hidden="true"
																								style="color:gray; display: inline-block; margin: 0 10px 0 0; font-size: 1.2em;"></i></a>
																						<?php } else { ?>
																						<a href="{{url('edit-candidate/' . @$alldata->id)}}"><i class="fa fa-edit"
																								aria-hidden="true"
																								style="color:gray; display: inline-block; margin: 0 10px 0 0; font-size: 1.2em;"></i></a>
																						<?php } ?>

																						<?php if (@$alldata->role_type == 2) { ?>
																						<a href="{{url('delete-users/' . @$alldata->id)}}"
																							onclick="alert('Are you sure to Delete ?');"><i class="fa fa-trash"
																								style="color:gray; font-size: 1.2em;"></i> </a>
																						<?php } else { ?>
																						<a href="{{url('delete-candidates/' . @$alldata->id)}}"
																							style="color:gray; font-size: 1.2em;"
																							onclick="alert('Are you sure to Delete ?');"><i
