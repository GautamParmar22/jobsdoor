...
<div class="app-wrapper">
	<div class="app-content pt-3 p-md-3 p-lg-4">
		<div class="container-xl">
			...
			<hr class="my-4">
			<form class="settings-form" action="{{url('update-candidate/' . $getCandidate->id)}}" method="POST"
				enctype='multipart/form-data' id='cnd_frm'>
				@csrf
					...
					<div class="col-12 col-md-8">
						<div class="app-card app-card-settings shadow-sm p-4">
							<div class="app-card-body">
								...
								<div class="mb-3">
									<label for="setting-input-firstname" class="form-label">Firstname<span class="ms-2"
									...
									<input type="text" class="form-control" id="setting-input-firstname"
										value="{{$personal->firstname}}" name="firstname">
								</div>
								<div class="mb-3">
									<label for="setting-input-lastname" class="form-label">Lastname<span class="ms-2"
											data-container="body" data-bs-toggle="popover" data-trigger="hover"
											data-placement="top"
											data-content="This is a Bootstrap popover example. You can use popover to provide extra info."></span></label>
									<input type="text" class="form-control" id="setting-input-lastname"
										value="{{$personal->lastname}}" name="lastname">
								</div>
								<div class="mb-3">
								...
								<div class="mb-3">
									...
									<input type="text" class="form-control" id="setting-input-mobile_no"
										name="mobile_no" value="{{$personal->mobile_no}}">
								</div>
								<div class="mb-3">
									<label for="setting-input_address" class="form-label">Address</label>
									<input type="text" class="form-control" id="setting-input-company_address"
										name="address" value="{{$personal->address}}">
								</div>
								<div class="mb-3">
									<label for="setting-input-city" class="form-label">City</label>
									<input type="text" class="form-control" id="setting-input-city" name="city"
										value="{{$personal->city}}">
								</div>
								<!--div class="mb-3">
								...
								<div class="mb-3">
									...
									<input type="text" class="form-control" id="setting-input-zip_code" name="zip_code"
										value="{{$personal->zip_code}}">
								</div>
								<div class="mb-3">
									<label for="setting-input-3" class="form-label">Start you</label>
									<input type="text" class="form-control" id="setting-input-3" name="start_job"
										value="{{$personal->start_job}}">
								</div>
					...
					<div class="col-12 col-md-8">
						<div class="app-card app-card-settings shadow-sm p-4 emp_details">
							<div class="mb-2"><strong>Is your first job: </strong>
								<input name="isFirstJobActive" type="checkbox" class="form-check-input"
									id="is_first_job_chkb" value="" <?php if ($personal->is_first_job == 1) {
	echo "checked";
}?>>
								<hr>
									...
									@foreach($editEmplyemntHitory as $key => $emp_hist)
										<div class="editEmplyemntHitory-{{$key}}">
											<div class="app-card-body" id="emp_recent_history">
												<div class="mb-3">
													<label for="setting-input-1" class="form-label">What is your most recent
														employement <span class="ms-2"></span></label>
													<input type="text" class="form-control" id="setting-input-1"
														value="{{$emp_hist->recent_employement}}"
														name="emp_history[0][recent_employement]">
												</div>
												<div class="mb-3">
													<label for="setting-input-1" class="form-label">Industry *<span
															class="ms-2" data-container="body" data-bs-toggle="popover"
															data-trigger="hover" data-placement="top"></span></label>
													<input type="text" class="form-control" id="setting-input-1"
														value="{{$emp_hist->industry}}" name="emp_history[0][industry]">
												</div>
												<div class="mb-3">
													<label for="setting-input-2" class="form-label">Your Official Job title
													</label>
													<input type="text" class="form-control" id="setting-input-2"
														name="emp_history[0][job_title]" value="{{$emp_hist->job_title}}">
												</div>
												<div class="mb-3">
													<label for="setting-input-3" class="form-label">How long have you been
														working at this position ?</label><br>
													<label for="setting-input-3" class="form-label">Start Date</label>
													<input type="text" class="form-control" id="emp_satrt_date"
														name="emp_history[0][start_date]" value="{{$emp_hist->start_date}}">
													<label for="setting-input-3" class="form-label">End Date</label>
													<input type="text" class="form-control" id="emp_end_date"
														name="emp_history[0][end_date]" value="{{$emp_hist->end_date}}">
												</div>
											</div>
											<input type="button" name="removeEmployment"
												class="btn-danger removeEmployment action-button removeEmployment"
												value="REMOVE " data-key="{{$key}}">
										</div>
									@endforeach
								</div>
								<?php } ?>
								<?php //echo "<pre>"; print_r($editEmplyemntHitory); "</pre>";?>
								<input type="button" name="addEmployment"
									class="btn btn-primary addEmployment action-button addEmployment"
									value="ADD EMPLOYEMENT " data-key="" style="float: right;">
								<br>
								<label for="setting-input-skill" class="form-label">Top skills </label>
								<?php $skills = explode(",", $personal->top_skills); ?>
								<div class="form-check">
									<div>
										<input class="form-check-input" type="checkbox" value="Communication" <?php if (in_array('Communication', $skills)) {
	echo "checked";
}?>
											id="Communication" name="top_skills[]">
										<label class="form-check-label" for="flexCheckChecked"
											id="flexCheckChecked1lbl">
											Communication
										</label>
									</div>

									<div class="form-check">
										<input class="form-check-input" type="checkbox" value="Leadership" <?php if (in_array('Leadership', $skills)) {
	echo "checked";
}?> id="Leadership"
											name="top_skills[]">
										<label class="form-check-label" for="flexCheckChecked"
											id="flexCheckChecked2lbl">
											Leadership
										</label>
									</div>

									<div class="form-check">
										<input class="form-check-input" type="checkbox" value="Confidence" <?php if (in_array('Confidence', $skills)) {
	echo "checked";
}?> id="Confidence"
											name="top_skills[]">
										<label class="form-check-label" for="flexCheckChecked"
											id="flexCheckChecked3lbl">
											Confidence
										</label>
									</div>

									<div class="form-check">
										<input class="form-check-input" type="checkbox" value="Queick Learner" <?php if (in_array('Queick Learner', $skills)) {
	echo "checked";
}?>
											id="Queick Learner" name="top_skills[]">
										<label class="form-check-label" for="flexCheckChecked"
											id="flexCheckChecked4lbl">
											Queick Learner
										</label>
									</div>

									<div class="form-check">
										<input class="form-check-input" type="checkbox" value="Team Work" <?php if (in_array('Team Work', $skills)) {
	echo "checked";
}?> id="Team Work"
											name="top_skills[]">
										<label class="form-check-label" for="flexCheckChecked"
											id="flexCheckChecked5lbl">
											Team Work
										</label>
									</div>
								</div>
					...
					<div class="col-12 col-md-8">
						<div class="app-card app-card-settings shadow-sm p-4">
							<div class="app-card-body">
								...
								<div class="mb-3">
									<label for="setting-input-1" class="form-label">School name<span
											class="ms-2"></span></label>
									<input type="text" class="form-control" id="setting-input-1"
										value="{{$education->school_name}}" name="school_name">
								</div>
								<div class="mb-3">
									<label for="setting-input-1" class="form-label">Degree<span class="ms-2"
											data-container="body" data-bs-toggle="popover" data-trigger="hover"
											data-placement="top"
											data-content="This is a Bootstrap popover example. You can use popover to provide extra info."></span></label>
									<input type="text" class="form-control" id="setting-input-1"
								...
								<div class="mb-3">
									...
									<input type="text" class="form-control" id="setting-input-2" name="field_of_study"
										value="{{$education->field_of_study}}">
								</div>
								<div class="mb-3">
									<label for="setting-input-3" class="form-label">Education start year</label>
									<select id="edustartyr" name="edu_start_year" class="form-control"
										value="{{$education->edu_start_year}}">
...
for ($year = date('Y'); $year >= (date('Y') - 100); $year--) {
	echo "<option value=$year>$year</option>";
								...
								<div class="mb-3">
									...
									<select name="edu_start_month" class="form-control" id="eduendmonth"
										value="{{$education->edu_start_month}}">
								...
								<div class="mb-3">
									...
									<select id="edustartyr" name="edu_end_year" class="form-control"
										value="{{$education->edu_end_year}}">
...
for ($year = date('Y'); $year >= (date('Y') - 100); $year--) {
	echo "<option value=$year>$year</option>";
								...
								<div class="mb-3">
									...
									<select name="edu_end_month" class="form-control" id="eduendmonth"
										value="{{$education->edu_end_month}}">
					...
					<div class="col-12 col-md-8">
						<div class="app-card app-card-settings shadow-sm p-4">
							<div class="app-card-body">
								...
								<div class="mb-3">
									<label for="setting-input-apply_job_title" class="form-label">What is Job title are
										you looking for ?<span class="ms-2" data-container="body"
											data-bs-toggle="popover" data-trigger="hover"
											data-placement="top"></span></label>
									<input type="text" class="form-control" id="setting-input-apply_job_title"
										name="apply_job_title" value="{{$editJobPreference->apply_job_title}}">
								</div>
								<div class="mb-3">
									<label for="setting-input-job_open" class="form-label">What types of Job are you
										open to ? </label>
									<input type="text" class="form-control" id="setting-input-job_open" name="job_open"
										value="{{$editJobPreference->job_open}}">
								</div>
								<label for="setting-input-salary_from" class="form-label">What is your target salary
									range? </label>
								<div class="mb-3">
									<label for="setting-input-salary_from" class="form-label">From</label>
									<input type="text" class="form-control" id="setting-input-salary_from"
										name="salary_from" value="{{$editJobPreference->salary_from}}">
								</div>
								<div class="mb-3">
									<label for="setting-input-salary_to" class="form-label">To</label>
									<input type="text" class="form-control" id="setting-input-salary_to"
										name="salary_to" value="{{$editJobPreference->salary_to}}">
								</div>
								<div class="mb-3">
									<label for="setting-input-prefer_work" class="form-label">Where would you prefer to
										work?</label>
									<input type="text" class="form-control" id="setting-input-prefer_work"
										name="prefer_work" value="{{$editJobPreference->prefer_work}}">
								</div>
								<div class="mb-3">
									<label for="setting-input-company" class="form-label">Company</label>
									<select name="company" class="form-control" id="company"
										value="{{$editJobPreference->company}}">
								...
								<div class="mb-3">
									...
									<select name="company_size" class="form-control" id="company_size"
										value="{{$editJobPreference->company_size}}">
										<option value="10" <?php if ($editJobPreference->company_size == 10) {?>
											selected<?php } ?>>10</option>
										<option value="20" <?php if ($editJobPreference->company_size == 20) {?>
											selected<?php } ?>>20</option>
										<option value="30" <?php if ($editJobPreference->company_size == 30) {?>
											selected<?php } ?>>30</option>
										<option value="40" <?php if ($editJobPreference->company_size == 40) {?>
											selected<?php } ?>>40</option>
										<option value="50" <?php if ($editJobPreference->company_size == 50) {?>
											selected<?php } ?>>50</option>
										<option value="90" <?php if ($editJobPreference->company_size == 90) {?>
											selected<?php } ?>>90</option>
									</select>
								</div>
								<div class="mb-3">
									<label for="setting-input-important_roll" class="form-label">What are the top 3
										things that are important to you for your next roll ?</label>
									<input type="text" class="form-control" id="setting-input-important_roll"
										name="important_roll" value="{{$editJobPreference->important_roll}}">
								</div>
								<div class="mb-3">
									<label for="setting-input-tell_yourself" class="form-label">Tell us a littel about
										yourself</label>
									<input type="text" class="form-control" id="setting-input-tell_yourself"
										name="tell_yourself" value="{{$editJobPreference->tell_yourself}}">
								</div>
								<div class="mb-3">
									...
									<select class="form-label form-control" name="status" id="setting-input-status">
										<option value="1" <?php if ($getCandidate->status == 1) {?> selected<?php } ?>>
											Active</option>
										<option value="0" <?php if ($getCandidate->status == 0) {?> selected<?php } ?>>
											InActive</option>
									</select>
								</div>
								<button type="submit" class="btn app-btn-primary">Save Changes</button>
