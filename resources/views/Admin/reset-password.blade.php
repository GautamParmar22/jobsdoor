	    ...
	    <div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
		    <div class="d-flex flex-column align-content-end">
			    <div class="app-auth-body mx-auto">	
				    <div class="app-auth-branding mb-4"><a class="app-logo" href="{{url('index-page')}}"><img class="logo-icon me-2" src="{{URL::asset('assets/admin/images/app-logo.svg')}}" alt="logo"></a></div>
