...
<div class="app-wrapper">
  <div class="app-content pt-3 p-md-3 p-lg-4">
    ...
    @endif
      ...
      <hr class="my-4">
      <form class="settings-form" action="{{url('update-job-post/' . $edit_post->id)}}" method="POST"
            ...
            <div class="app-card app-card-settings shadow-sm p-4">
              <div class="app-card-body">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="setting-input-1" value="{{$edit_post->job_name}}"
                    name="job_name">
                </div>
                <div class="mb-3">
                  <label for="setting-input-1" class="form-label">No of vacancy<span class="ms-2" data-container="body"
                      data-bs-toggle="popover" data-trigger="hover" data-placement="top"></span></label>
                  <input type="text" class="form-control" id="setting-input-1" value="{{$edit_post->no_of_vacancy}}"
                    name="no_of_vacancy">
                </div>
                <div class="mb-3">
                  ...
                  <textarea class="form-control valid" id="setting-input-2" name="job_description"
                    style="height: 194px;" aria-invalid="false">{{ $edit_post->job_description }}</textarea>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="setting-input-3" name="qualification"
                    value="{{$edit_post->qualification}}">
                </div>
                <div class="mb-3">
                  <label for="setting-input-3" class="form-label">Salary to</label>
                  <input type="text" class="form-control" id="setting-input-3" name="salary"
                    value="{{$edit_post->salary_to}}">
                </div>
                <div class="mb-3">
                  <label for="setting-input-3" class="form-label">Salary from</label>
                  <input type="text" class="form-control" id="setting-input-3" name="salary"
                    value="{{$edit_post->salary_from}}">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <select class="form-label form-control" name="type_of_job" id="setting-input-type_of_job">
                    <option value="fulltime" <?php if ($edit_post->type_of_job == 'fulltime') {?> selected<?php } ?>>Full
                      time</option>
                    <option value="parttime" <?php if ($edit_post->type_of_job == 'parttime') {?> selected<?php } ?>>Part
                      time</option>
                  </select>
                </div>
                <div class="mb-3">
                  ...
                  <div class="resume-file form-control">
                    <input type="file" class="site-button" id="documentUpload" name="choosefile"
                      src="{{asset('intro_pdf/' . $edit_post->image)}}" value="{{$edit_post->indroduction_pdf}}">

                    <a href="{{env('APP_URL')}}/intro_pdf/{{$edit_post->indroduction_pdf}}"
                      download="{{$edit_post->indroduction_pdf}}" target="_blank" class="btn btn-info btn-sm"
                      class="viewpdf">View Introduction PDF</a>
