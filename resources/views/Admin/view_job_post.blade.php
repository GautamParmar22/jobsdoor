				...
				<div class="col-12 col-md-8">
					<div class="app-card app-card-settings shadow-sm p-4">
						<div class="app-card-body">
							...
							<div class="mb-2"><strong>No of vacancy: </strong>{{$display_job_posts->no_of_vacancy}}
							</div>
							<div class="mb-2"><strong>Type of job: </strong>{{$display_job_posts->type_of_job}}</div>
							<div class="mb-2"><strong>Description of job:
								</strong>{{$display_job_posts->job_description}}</div>
							<div class="mb-2"><strong>Key skills: </strong>{{$display_job_posts->key_skills}}</div>
							<div class="mb-2"><strong>Qualification: </strong>{{$display_job_posts->qualification}}
							</div>
							...
							<div class="mb-2"><strong>Describe PDF: </strong>
								<a href="{{env('APP_URL')}}/intro_pdf/{{$display_job_posts->indroduction_pdf}}"
									download="{{$display_job_posts->indroduction_pdf}}" target="_blank"
									class="btn btn-info btn-sm">View Introduction PDF</a>
							</div>
							<div class="mb-2"><strong>Status: </strong>
								@if($display_job_posts->status == 1)
