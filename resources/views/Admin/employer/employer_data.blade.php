									...
									<tbody>
										@foreach($allemployers as $allemp)
																				<tr>
																					...
																					<td class="cell">
																						<span><?php if ($allemp->official_title == "") {
												echo "--";
											} else {
												echo $allemp->official_title;
											}?></span>
																					</td>
																					<td class="cell">
																						<?php
