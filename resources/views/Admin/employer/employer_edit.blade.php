...
<div class="app-wrapper">
	<div class="app-content pt-3 p-md-3 p-lg-4">
		<div class="container-xl">
			...
			<hr class="my-4">
			<form class="settings-form" action="{{url('update/' . $getEmployers->id)}}" method="POST"
				enctype='multipart/form-data' id='emp_frm'>
				@csrf
					...
					<div class="col-12 col-md-8">
						<div class="app-card app-card-settings shadow-sm p-4">
							<div class="app-card-body">
								...
								<div class="mb-3">
									<label for="setting-input-1" class="form-label">Firstname<span class="ms-2"
									...
									<input type="text" class="form-control" id="setting-input-1"
										value="{{$getEmployers->firstname}}" name="firstname">
								</div>
								<div class="mb-3">
									<label for="setting-input-1" class="form-label">Lastname<span class="ms-2"
											data-container="body" data-bs-toggle="popover" data-trigger="hover"
											data-placement="top"
											data-content="This is a Bootstrap popover example. You can use popover to provide extra info."></span></label>
									<input type="text" class="form-control" id="setting-input-1"
										value="{{$getEmployers->lastname}}" name="lastname">
								</div>
								<div class="mb-3">
									<label for="setting-input-2" class="form-label">Email</label>
									<input type="email" class="form-control" id="setting-input-2" name="email"
										value="{{$getEmployers->email}}">
								</div>
								<!--div class="mb-3">
								...
								<div class="mb-3">
									...
									<input type="text" class="form-control" id="setting-input-3" name="mobile_no"
										value="{{$getEmployers->emp_mobile}}">
								</div>
								<div class="mb-3">
									<label for="setting-input-3" class="form-label">Official title</label>
									<input type="text" class="form-control" id="setting-input-3" name="official_title"
										value="{{$getEmployers->official_title}}">
								</div>
								...
								<div class="mb-3">
									...
									<select name="reach_you" class="form-control" id="reach_you"
										value="{{$getEmployers->reach_you}}">
					...
					<div class="row g-4 settings-section">
						...
						<div class="col-12 col-md-8">
							<div class="app-card app-card-settings shadow-sm p-4">
								<div class="app-card-body">
									<div class="mb-3">
										<label for="setting-input-company_name" class="form-label">Company name<span
												class="ms-2" data-container="body" data-bs-toggle="popover"
												data-trigger="hover" data-placement="top"
												data-content="This is a Bootstrap popover example. You can use popover to provide extra info."></span></label>
										<input type="text" class="form-control" id="setting-input-company_name"
											name="company_name" value="{{$getEmployers->company_name}}">
									</div>
									<div class="mb-3">
										<label for="setting-input-industry" class="form-label">Industry</label>
										<input type="text" class="form-control" id="setting-input-industry"
											name="industry" value="{{$getEmployers->industry}}">
									</div>
									<div class="mb-3">
										<label for="setting-input-company_address" class="form-label">Company
											address</label>
										<input type="text" class="form-control" id="setting-input-company_address"
											name="company_address" value="{{$getEmployers->company_address}}">
									</div>
									<div class="mb-3">
										...
										<input type="text" class="form-control" id="setting-input-city" name="city"
											value="{{$getEmployers->city}}">
									</div>
									<div class="mb-3">
										<label for="setting-input-state" class="form-label">State</label>
										<input type="text" class="form-control" id="setting-input-state" name="state"
											value="{{$getEmployers->state}}">
									</div>
									<div class="mb-3">
										<label for="setting-input-country" class="form-label">Country</label>
										<input type="text" class="form-control" id="setting-input-country"
											name="country" value="{{$getEmployers->country}}">
									</div>
									<div class="mb-3">
										<label for="setting-input-zip_code" class="form-label">Zip code</label>
										<input type="text" class="form-control" id="setting-input-zip_code"
											name="zip_code" value="{{$getEmployers->zip_code}}">
									</div>
									<div class="mb-3">
										<label for="setting-input-website" class="form-label">Website</label>
										<input type="url" class="form-control" id="setting-input-website" name="website"
											value="{{$getEmployers->website}}">
									</div>
									<div class="mb-3">
										...
										<select class="form-label form-control" name="status" id="setting-input-status">
											<option value="1" <?php if ($getEmployers->status == 1) {?> selected<?php } ?>>
												Active</option>
											<option value="0" <?php if ($getEmployers->status == 0) {?> selected<?php } ?>>
												InActive</option>
										</select>
									</div>
