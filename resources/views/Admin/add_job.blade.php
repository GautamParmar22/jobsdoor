...
<div class="app-wrapper">
  <div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">  
        ...
        <div id="cancel" align="right"><a href="{{url('add-job-post')}}" style="color:gray; display: inline-block;"><i class="fa fa-window-close fa-3x"></i></a><i class=""></i>
        </div>
        <hr class="my-4">
        <form class="settings-form" action="{{url('insert-job-post')}}" method="POST" enctype='multipart/form-data' id='job_post'>
            @csrf
            <div class="row g-4 settings-section">
                ...
                <div class="app-card-body">
                  ...
                  <div class="mb-3">
                    <label for="setting-input-1" class="form-label">Job name<span class="ms-2" data-container="body" data-bs-toggle="popover" data-trigger="hover" data-placement="top" data-content="This is a Bootstrap popover example. You can use popover to provide extra info."></span></label>
