	    ...
	    <div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
		    <div class="d-flex flex-column align-content-end">
			    <div class="app-auth-body mx-auto">	
				    <div class="app-auth-branding mb-4"><a class="app-logo" href="{{url('index-page')}}"><img class="logo-icon me-2" style="height: auto; width: auto;" src="{{URL::asset('assets/admin/images/JobsDoor_Logo.svg')}}" alt="logo"></a></div>
			        ...
			        <div class="auth-form-container text-start">
						<form class="auth-form login-form" method="POST" action="{{url('admin-login')}}" id="loginfrm">  
							...
							<div class="email mb-3">
								...
								<input id="email" name="email" type="email" class="form-control email" placeholder="Email address">
							</div><!--//form-group-->
